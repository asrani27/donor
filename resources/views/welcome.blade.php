...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ url('LTE/index2.html')}}"><b>DONOR</b>SEHATI</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
      ...
      <div class="form-group has-feedback">
        <input type="username" name="username" value="{{ old('username') }}"  class="form-control" placeholder="Email/username">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
        <a href="{{url('/')}}" class="btn btn-primary btn-block btn-flat">Kembali</a>
        </div>
        <div class="col-xs-4">
        </div>
        <div class="col-xs-4">
  ...
  {{--   <a href="{{ url('LTE/register.html')}}" class="text-center">Register a new membership</a>
 --}}
  </div>
  <!-- /.login-box-body -->
</div>
